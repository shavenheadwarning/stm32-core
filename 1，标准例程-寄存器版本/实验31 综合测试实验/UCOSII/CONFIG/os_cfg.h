...
#define OS_TICKS_PER_SEC       	1000u   /* Set the number of ticks in one second                        *///500 1ms时基
...
#define OS_TMR_CFG_TICKS_PER_SEC 1000u  /*     Rate at which timer management task runs (Hz)            */  //1ms定时
